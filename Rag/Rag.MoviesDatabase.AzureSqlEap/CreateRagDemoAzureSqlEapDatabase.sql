/****** Object:  Database [rag-demo-eap-3s]    Script Date: 9/16/2024 5:23:24 PM ******/
CREATE DATABASE [rag-demo-eap-3s]  (EDITION = 'GeneralPurpose', SERVICE_OBJECTIVE = 'GP_S_Gen5_1', MAXSIZE = 32 GB) WITH CATALOG_COLLATION = SQL_Latin1_General_CP1_CI_AS, LEDGER = OFF;
GO
ALTER DATABASE [rag-demo-eap-3s] SET COMPATIBILITY_LEVEL = 160
GO
ALTER DATABASE [rag-demo-eap-3s] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [rag-demo-eap-3s] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [rag-demo-eap-3s] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [rag-demo-eap-3s] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [rag-demo-eap-3s] SET ARITHABORT OFF 
GO
ALTER DATABASE [rag-demo-eap-3s] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [rag-demo-eap-3s] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [rag-demo-eap-3s] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [rag-demo-eap-3s] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [rag-demo-eap-3s] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [rag-demo-eap-3s] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [rag-demo-eap-3s] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [rag-demo-eap-3s] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [rag-demo-eap-3s] SET ALLOW_SNAPSHOT_ISOLATION ON 
GO
ALTER DATABASE [rag-demo-eap-3s] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [rag-demo-eap-3s] SET READ_COMMITTED_SNAPSHOT ON 
GO
ALTER DATABASE [rag-demo-eap-3s] SET  MULTI_USER 
GO
ALTER DATABASE [rag-demo-eap-3s] SET ENCRYPTION ON
GO
ALTER DATABASE [rag-demo-eap-3s] SET QUERY_STORE = ON
GO
ALTER DATABASE [rag-demo-eap-3s] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 100, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
/*** The scripts of database scoped configurations in Azure should be executed inside the target database connection. ***/
GO
-- ALTER DATABASE SCOPED CONFIGURATION SET MAXDOP = 8;
GO
/****** Object:  DatabaseScopedCredential [BlobStorageCredential]    Script Date: 9/16/2024 5:23:25 PM ******/
CREATE DATABASE SCOPED CREDENTIAL [BlobStorageCredential] WITH IDENTITY = N'SHARED ACCESS SIGNATURE'
GO
/****** Object:  UserDefinedFunction [dbo].[GetMoviesJsonUdf]    Script Date: 9/16/2024 5:23:25 PM ******/
SET ANSI_NULLS OFF
GO
...
END
GO
/****** Object:  ExternalDataSource [BlobStorageContainer]    Script Date: 9/16/2024 5:23:26 PM ******/
...
GO
/****** Object:  Table [dbo].[AppConfig]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
...
GO
/****** Object:  Table [dbo].[Genre]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Movie]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MovieGenre]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MovieProductionCompany]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MovieProductionCountry]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MovieSpokenLanguage]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProductionCompany]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProductionCountry]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SpokenLanguage]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[AskQuestion]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[DeleteAllData]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[DeleteMovie]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[DeleteStarWarsTrilogy]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[LoadConfig]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[LoadMovies]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[RunVectorSearch]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[VectorizeMovies]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[VectorizeText]    Script Date: 9/16/2024 5:23:26 PM ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
...
END
GO
ALTER DATABASE [rag-demo-eap-3s] SET  READ_WRITE 
GO

...
namespace Rag.AIClient.RagProviders.NoSql.MongoDb
{
	public class MongoDbDataPopulator : IDataPopulator
	{
		public async Task LoadData()
		{
			...
			await this.CreateDocuments(@$"Data\{Shared.AppConfig.MongoDb.JsonInitialDataFilename}", collection);
		}
		...
		public async Task UpdateData()
		{
			...
			await this.CreateDocuments(@$"Data\{Shared.AppConfig.MongoDb.JsonUpdateDataFilename}", collection);
		}
